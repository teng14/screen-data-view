...
<template lang="pug">
  .module
    ModuleBox.dv-box(title='茶叶分类销售占比', type='right')
      .chart
        .chart-bd
          <Chart :options="fenleiOptions" style="width:430px;height:16.5rem" />

    ModuleBox.dv-box(title='渠道销售信息', type='right')
      .chart
        .chart-bd
          <Chart :options="qudaoOptions" style="width:430px;height:16.5rem" />

    ModuleBox.dv-box(title='全年茶叶销售产值', type='right')
      .chart
        .chart-bd
          <Chart :options="chanzhiOptions" style="width:430px;height:16.5rem" />
</template>
